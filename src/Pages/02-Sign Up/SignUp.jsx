          ...
          <div className="row border shadow">
            ...
            <div className="col-md-6 right">
              ...
              <form className="mx-3 needs-validation" onSubmit={handleSubmit}>
                <InputText valueLabel="Nama Depan" valueFor="nama-depan" type="text" id="nama-depan" name="nama-depan" placeholder="Masukkan Nama Depan" value={namaDepan} onChange={(e) => setNamaDepan(e.target.value)}/>
                <InputText valueLabel="Nama Belakang" valueFor="nama-belakang" type="text" id="nama-belakang" name="nama-belakang" placeholder="Masukkan Nama Belakang" value={namaBelakang} onChange={(e) => setNamaBelakang(e.target.value)}/>
