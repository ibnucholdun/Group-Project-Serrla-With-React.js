...
import module from './ContactUs.module.css';
  ...
  return (
    <>
        <main>
            ...
            <section class={module["contact-us"]}>
                <div class={`${module['container']} my-5 rounded-5`}>
                    <div class="row p-5">
                    ...
                    <div class={module["mapouter"]}>
                        <div class={module["gmap_canvas"]}>
                            <iframe title="map" class={module['gmap_iframe']} width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Jl. Durian Raya No. 30A, RT. 4/RW. 4 Jagakarsa, Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12620  &amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
